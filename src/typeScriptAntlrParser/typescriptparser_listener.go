...
type TypeScriptParserListener interface {
	...
	// EnterNestedTypeGeneric is called when entering the nestedTypeGeneric production.
	EnterNestedTypeGeneric(c *NestedTypeGenericContext)
	...
	// EnterPropertyDeclarationExpression is called when entering the PropertyDeclarationExpression production.
	EnterPropertyDeclarationExpression(c *PropertyDeclarationExpressionContext)

	// EnterMethodDeclarationExpression is called when entering the MethodDeclarationExpression production.
	EnterMethodDeclarationExpression(c *MethodDeclarationExpressionContext)

	// EnterGetterSetterDeclarationExpression is called when entering the GetterSetterDeclarationExpression production.
	EnterGetterSetterDeclarationExpression(c *GetterSetterDeclarationExpressionContext)

	// EnterAbstractMemberDeclaration is called when entering the AbstractMemberDeclaration production.
	EnterAbstractMemberDeclaration(c *AbstractMemberDeclarationContext)
	...
	// EnterCastAsExpression is called when entering the CastAsExpression production.
	EnterCastAsExpression(c *CastAsExpressionContext)
	...
	// ExitNestedTypeGeneric is called when exiting the nestedTypeGeneric production.
	ExitNestedTypeGeneric(c *NestedTypeGenericContext)
	...
	// ExitPropertyDeclarationExpression is called when exiting the PropertyDeclarationExpression production.
	ExitPropertyDeclarationExpression(c *PropertyDeclarationExpressionContext)

	// ExitMethodDeclarationExpression is called when exiting the MethodDeclarationExpression production.
	ExitMethodDeclarationExpression(c *MethodDeclarationExpressionContext)

	// ExitGetterSetterDeclarationExpression is called when exiting the GetterSetterDeclarationExpression production.
	ExitGetterSetterDeclarationExpression(c *GetterSetterDeclarationExpressionContext)

	// ExitAbstractMemberDeclaration is called when exiting the AbstractMemberDeclaration production.
	ExitAbstractMemberDeclaration(c *AbstractMemberDeclarationContext)
	...
	// ExitCastAsExpression is called when exiting the CastAsExpression production.
	ExitCastAsExpression(c *CastAsExpressionContext)
	...
	ExitpPrimType(s *pPrimTypeContext)
	EnterpPrimType(s *pPrimTypeContext)
	EnterpExpression(s *pExpressionContext)
	ExitpExpression(s *pExpressionContext)
}
